  ...
  <body class="bg-gray-50 text-gray-900">
    ...
    <div class="max-w-6xl mx-auto p-4 py-12">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
        ...
        <!-- Specialized Agents Monitor Card -->
        <a href="/agents-monitor" class="block">
          <div class="bg-white rounded-xl shadow-md p-6 card-hover">
            ...
            <h2 class="text-2xl font-semibold text-gray-900 mb-2">Specialized Agents</h2>
            <p class="text-gray-600">Monitor specialized agent delegations, tool usage, and active comments.</p>
          </div>
        </a>
